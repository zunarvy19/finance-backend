...
func (h *Handler) Create(c fiber.Ctx) error {
	...
	return common.SendSuccess(c, fiber.StatusCreated, "Transaction created successfully", res)
}
...
func (h *Handler) Update(c fiber.Ctx) error {
	...
	if err != nil {
		return common.SendError(c, fiber.StatusBadRequest, "Invalid transaction ID", nil)
	}
	...
	return common.SendSuccess(c, fiber.StatusOK, "Transaction updated successfully", res)
}
...
func (h *Handler) Delete(c fiber.Ctx) error {
	...
	return common.SendSuccess(c, fiber.StatusOK, "Transaction deleted successfully", nil)
}
...
func (h *Handler) Get(c fiber.Ctx) error {
	...
	return common.SendSuccess(c, fiber.StatusOK, "Transaction retrieved successfully", res)
}
...
func (h *Handler) List(c fiber.Ctx) error {
	...
	return common.SendSuccess(c, fiber.StatusOK, "Transactions retrieved successfully", res)
}
