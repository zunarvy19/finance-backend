...
func (h *Handler) Create(c fiber.Ctx) error {
	...
	return common.SendSuccess(c, fiber.StatusCreated, "Category created successfully", res)
}
...
func (h *Handler) Update(c fiber.Ctx) error {
	...
	if err != nil {
		return common.SendError(c, fiber.StatusBadRequest, "Invalid category ID", nil)
	}
	...
	return common.SendSuccess(c, fiber.StatusOK, "Category updated successfully", res)
}
...
func (h *Handler) Delete(c fiber.Ctx) error {
	...
	return common.SendSuccess(c, fiber.StatusOK, "Category deleted successfully", nil)
}
...
func (h *Handler) Get(c fiber.Ctx) error {
	...
	return common.SendSuccess(c, fiber.StatusOK, "Category retrieved successfully", res)
}
...
func (h *Handler) List(c fiber.Ctx) error {
	...
	return common.SendSuccess(c, fiber.StatusOK, "Categories retrieved successfully", res)
}
